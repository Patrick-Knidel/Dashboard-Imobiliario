      ...
      <div class="col">
        <div class="card shadow">
          <div class="card-header border-1">
            <h3 class="mb-0">Status Cadastro de Usuario</h3>
          </div>
          ...
          <div class="container" style="margin-top: 10px">
            <?php
              ...
              $sql = "INSERT INTO `usuario`(`nome_usuario`, `nivel_acesso_usuario`, `email_usuario`, `usuario`, `senha_usuario`) VALUES ('$nome','$nivel','$email','$usuario','$senha')";
